  ...
  render(){
    return(
      <div className="container-fluid col-md-3 col-sm-4 col-xs-11 about">
        ...
        <p className = "p1">I'm a psychologist turned web developer. I enjoy solving new problems and coming up with ways to make my life and other's lives easier. My passion for people transfers nicely into developing products with users in mind. I love the mix of developing a simple, yet beautiful front-end site with the exciting problem solving aspects of developing the back-end.</p>

        <p className = "p2">Learning new things keeps my fire for coding alive, and, luckily, in web development, there is always something new to learn.  When I'm not programming, you can find me in the mountains exploring new territory, or just on my couch watching Netflix and eating pizza.  Now that you know more about me, check out my projects, or if you are really interested, shoot me an email.</p>
      </div>
        </div>
    )
  }
